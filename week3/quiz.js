...
//Question 2: 
const howManySibsPrompt = parseInt(prompt(`How many siblings does Kate have?`,99));
const howManySibsCorrect = 2;

if ((howManySibsPrompt === `null`) || (howManySibsPrompt && howManySibsPrompt.trim() === ``) || (howManySibsPrompt === NaN)) {
   alert('Your answer is not valid and you will receive a 0 for this question');
   } else if (howManySibsPrompt.trim() === howManySibsCorrect) {
      ++score;
   }
//Give error for invalid answer, trim to match the answers, 
...
console.log("===Q2 Siblings Trim Answers===");
console.log(howManySibsPrompt.trim());
console.log(howManySibsCorrect);
console.log("===Auto Score 0 Evaluation===")
...
if (score = 0) {
   alert(`You don't know Kate at all! 0%, No answers correct. Maybe you cancelled and didn't answer the questions... try again!`);
   ...
   alert(`You and Kate are pretty close! You got ${percentCorrect}% of the questions right. Kate still has stuff for you to find out...`);
