...
3. Variable: charName - string from prompt
4. Variable: pet - string from prompt
5. Variable: superpower - string from prompt
6. Variable: yearsTrainingText - string from prompt
7. Variable: yearsTraining - convert string to number
8. Variable: powerLevel - number calc
9. Variable: likesFighting - confirm
*/
